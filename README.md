...
- `4.6 Accessibility`: tamamlanmis v1. OCR + DINO + metadata destekli visual-first accessibility analiz akisi, history ve URL/screenshot parity ile aktif.
...
- `4.4 Dataset`: guclu v1+. Validation, class balance, duplicate/suspicious label sinyali, split health, training risk, synthetic suggestion ve model impact aktif.
